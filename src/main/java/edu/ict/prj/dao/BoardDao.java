...
public class BoardDao {
	...
	public int delete(String id) {// delete update insert는 resultSet이 필요없다.
	...
	public int write(String bname, String btitle, String bcontent) {// delete update insert는 resultSet이 필요없다.
	...
	private void replyShape(String group, String step) {
		...
		String sql = "update mvc_board set bstep = bstep +1 where bgroup =? ans bstep >?";
